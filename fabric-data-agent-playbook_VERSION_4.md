...
![Excel Copilot Button](screenshots/47__Excel_Copilot_Button.png)
...
![Copilot Pane](screenshots/48__Copilot_Pane.png)
...
![Select AR Agent](screenshots/49__Select_AR_Agent.png)
...
![Excel Donut Request](screenshots/50__Excel_Donut_Request.png)
...
![Add to New Sheet](screenshots/51__Add_to_New_Sheet.png)
...
![Donut in Excel](screenshots/52__Donut_in_Excel.png)
...
![Agent Details](screenshots/53__Agent_Details.png)
...
![Agent Instructions](screenshots/54__Agent_Instructions.png)
...
![Add Agent](screenshots/55__Add_Agent.png)
...
![Select Microsoft Fabric](screenshots/56__Select_Microsoft_Fabric.png)
...
![Authenticate Connection](screenshots/57__Authenticate_Connection.png)
...
![Select AR Agent](screenshots/58__Select_AR_Agent.png)
...
![Configure Agent](screenshots/59__Configure_Agent.png)
...
![Agent Configuration](screenshots/60__Agent_Configuration.png)
...
![Both Agents Available](screenshots/60__Both_Agent_Available.png)
...
1. From the **Agents** tab, click the menu (three dots) and select **Channels**

![Go to Channels](screenshots/61__Go_to_channel.png)
...
![Select Teams Channel](screenshots/62__Select_Teams.png)
...
![Add Channel](screenshots/63__Click_Add_chanel.png)
...
![Channel Added Confirmation](screenshots/64__Channel_added_Confirmation.png)
...
![Agent in Teams](screenshots/65__Agent_in_Teams.png)
...
![Connect to Continue](screenshots/66__Connect_to_Continue.png)
...
![Overdue Receivables Response](screenshots/67__Overdue_Response.png)
...
![Cross-Domain Response](screenshots/68__Cross_Domain_Response.png)
